...
class ContractTestContext {
    ...
    async setup() {
        ...
        const contractCoordinator = await ethers.getContractFactory(
            "Coordinator"
        );
