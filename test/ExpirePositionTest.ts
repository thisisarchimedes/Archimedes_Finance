...
import { createPositionFixture, defaultAuction, getDefaultPosition, setupContractsFixture, setupUpgradesFixture, startAuctionFixture } from "./envSetupForTests";
...
async function moveTimeForward(days: number = 32) {
