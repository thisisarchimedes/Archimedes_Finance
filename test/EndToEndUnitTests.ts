...
describe("Test suit for setting up the stage", function () {
    ...
    //     expect(lvUSDCoinsInPool).to.gt(parseUnitsNum(initialFundsInPool));
    //     expect(crvCoinsInPool).to.gt(parseUnitsNum(initialFundsInPool));
    // });
...
//     //     totalOUSDPositionIn18Dec = await r.cdp.getOUSDTotal(positionId);
