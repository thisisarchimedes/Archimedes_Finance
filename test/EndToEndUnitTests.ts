...
describe("Building basic environment", function () {
    async function setupEnvForIntegrationTestsFixture() {
        ...
        */
        ...
        await fundMetapool(lvUSD3CRVPoolInstance.address,
    ...
    describe("Test minLeveage and minReturn", function () {
        ...
        it("Create position with accurate minLeverage", async function () {
            ...
            await approveAndGetLeverageAsUser(userOUSDPrinciple, cycles, archCostOfLeverageIn18Dec, r, user);
    ...
    //         const minReturnedOUSD = userOUSDPrincipleIn18Decimal.mul(99).div(100);
    ...
    //         .add(BigNumber.from(1 * Math.round(Math.random())));
