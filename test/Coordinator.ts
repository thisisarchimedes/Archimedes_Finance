...
describe("Coordinator Test suit", function () {
    ...
    describe("Coordinator overview testing", function () {
        ...
        before(async function () {
            ...
            console.log("Get % leverage", ethers.utils.formatEther(leverageToGetForPosition));
            ...
            await coordinator.depositCollateralUnderNFT(endToEndTestNFTId, collateralAmount);
        ...
        it("Should have updated CDP", async function () {
