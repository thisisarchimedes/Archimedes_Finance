...
contract Auction is IAuction {
    ...
    function startAuction(uint256 endBlock, uint256 startPrice, uint256 endPrice) external override {
    ...
    function _IsValidAuctionParams(uint256 endBlock, uint256 startPrice, uint256 endPrice) internal pure returns (bool) {
        return true;
    }

    function _setAuctionPrivateMembers(uint256 endBlock, uint256 startPrice, uint256 endPrice) internal {
